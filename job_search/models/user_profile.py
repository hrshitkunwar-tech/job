...
class UserProfile(Base):
    ...
    technical_manifesto = Column(Text, nullable=True)
    preferred_team_style = Column(String(100), nullable=True)
    execution_preference = Column(String(100), nullable=True)
    company_stage_preference = Column(String(100), nullable=True)
    autonomy_preference = Column(String(100), nullable=True)
    frontier_tech_interest = Column(Integer, nullable=True)
